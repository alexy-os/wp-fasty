...
class TemplateEditor
{
    ...
    private function generateStaticHtml($postId, $template, $templateData): void
    {
        ...
        try {
            ...
            // Сохраняем относительный путь в мета-данных
...
HTML;
    ...
    {
        // Используем PHP для рендеринга шаблона
        ob_start();
        ?>
        <script>
