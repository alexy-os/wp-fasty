...
return function (Container $container): void {
    ...
    $container->singleton('tools.context_schema_command', function ($container) {
        return new ContextSchemaCommand();
    }, ContextSchemaCommand::class);
    $container->addTag('tools.context_schema_command', ContainerInterface::TAG_BOOTABLE);
